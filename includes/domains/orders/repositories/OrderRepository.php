...
class OrderRepository implements RepositoryInterface
{
    ...
    private function saveOrderMeta(int $post_id, array $data): void
    {
        $meta_fields = [
            ...
            '_delivery_base_fee' => $data['delivery_base_fee'] ?? 0.0,
            '_delivery_time_surcharge' => $data['delivery_time_surcharge'] ?? 0.0,
            '_delivery_loyalty_discount' => $data['delivery_loyalty_discount'] ?? 0.0,
            ...
            '_delivery_type' => $data['delivery_type'] ?? null,
            '_tracking_token' => $data['tracking_token'] ?? null,
    ...
    private function updateOrderMeta(int $post_id, array $data): void
    {
        $updatable_fields = [
            ...
            'delivery_base_fee' => '_delivery_base_fee',
            'delivery_time_surcharge' => '_delivery_time_surcharge',
            'delivery_loyalty_discount' => '_delivery_loyalty_discount',
