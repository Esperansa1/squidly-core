      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="p-6">
          <p className="text-gray-700 text-right leading-relaxed">
            האם אתה בטוח שברצונך לדחות את ההזמנה <span className="font-bold">#{orderId}</span>?
          </p>
          <p className="text-gray-600 text-right text-sm mt-2">
            פעולה זו תעדכן את הלקוח על דחיית ההזמנה.
          </p>
        </div>
