...
return array(
    'Address' => $baseDir . '/includes/shared/models/Address.php',
    'AdminEnhancements' => $baseDir . '/includes/admin/AdminEnhancements.php',
    'AdminMenuManager' => $baseDir . '/includes/admin/AdminMenuManager.php',
    'BasePostType' => $baseDir . '/includes/shared/abstracts/BasePostType.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'Customer' => $baseDir . '/includes/domains/customers/models/Customer.php',
    'CustomerPostType' => $baseDir . '/includes/domains/customers/post-types/CustomerPostType.php',
    'CustomerRepository' => $baseDir . '/includes/domains/customers/repositories/CustomerRepository.php',
    'GroupItem' => $baseDir . '/includes/domains/products/models/GroupItem.php',
    'GroupItemPostType' => $baseDir . '/includes/domains/products/post-types/GroupItemPostType.php',
    'GroupItemRepository' => $baseDir . '/includes/domains/products/repositories/GroupItemRepository.php',
    ...
    'Ingredient' => $baseDir . '/includes/domains/products/models/Ingredient.php',
    'IngredientPostType' => $baseDir . '/includes/domains/products/post-types/IngredientPostType.php',
    'IngredientRepository' => $baseDir . '/includes/domains/products/repositories/IngredientRepository.php',
    'ItemType' => $baseDir . '/includes/shared/models/enums/ItemType.php',
    'Order' => $baseDir . '/includes/domains/orders/models/Order.php',
    'OrderItem' => $baseDir . '/includes/domains/orders/models/OrderItem.php',
    'OrderPostType' => $baseDir . '/includes/domains/orders/post-types/OrderPostType.php',
    'OrderRepository' => $baseDir . '/includes/domains/orders/repositories/OrderRepository.php',
    ...
    'PaymentException' => $baseDir . '/includes/domains/payments/exceptions/PaymentException.php',
    'PaymentGatewayInterface' => $baseDir . '/includes/domains/payments/interfaces/PaymentGatewayInterface.php',
    'PaymentIntent' => $baseDir . '/includes/domains/payments/models/PaymentIntent.php',
    'PaymentManager' => $baseDir . '/includes/domains/payments/managers/PaymentManager.php',
    'PaymentRequest' => $baseDir . '/includes/domains/payments/models/PaymentRequest.php',
    'PaymentResult' => $baseDir . '/includes/domains/payments/models/PaymentResult.php',
    'PaymentService' => $baseDir . '/includes/domains/payments/services/PaymentService.php',
    'PaymentStatus' => $baseDir . '/includes/domains/payments/models/PaymentStatus.php',
    'PaymentWebhookResult' => $baseDir . '/includes/domains/payments/models/PaymentWebhookResult.php',
    ...
    'PostTypeInterface' => $baseDir . '/includes/shared/interfaces/PostTypeInterface.php',
    'PostTypeRegistry' => $baseDir . '/includes/core/PostTypeRegistry.php',
    'Product' => $baseDir . '/includes/domains/products/models/Product.php',
    'ProductGroup' => $baseDir . '/includes/domains/products/models/ProductGroup.php',
    'ProductGroupPostType' => $baseDir . '/includes/domains/products/post-types/ProductGroupPostType.php',
    'ProductGroupRepository' => $baseDir . '/includes/domains/products/repositories/ProductGroupRepository.php',
    'ProductPostType' => $baseDir . '/includes/domains/products/post-types/ProductPostType.php',
    'ProductRepository' => $baseDir . '/includes/domains/products/repositories/ProductRepository.php',
    'RepositoryInterface' => $baseDir . '/includes/shared/interfaces/RepositoryInterface.php',
    'ResourceInUseException' => $baseDir . '/includes/shared/exceptions/ResourceInUseException.php',
    ...
    'StoreBranch' => $baseDir . '/includes/domains/stores/models/StoreBranch.php',
    'StoreBranchPostType' => $baseDir . '/includes/domains/stores/post-types/StoreBranchPostType.php',
    'StoreBranchRepository' => $baseDir . '/includes/domains/stores/repositories/StoreBranchRepository.php',
    'StripePaymentGateway' => $baseDir . '/includes/domains/payments/gateways/StripePaymentGateway.php',
