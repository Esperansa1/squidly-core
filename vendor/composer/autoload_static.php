...
class ComposerStaticInitfbee484fbcb98ba45566f17e8eb69e9b
{
    ...
    public static $classMap = array (
        'Address' => __DIR__ . '/../..' . '/includes/shared/models/Address.php',
        'AdminEnhancements' => __DIR__ . '/../..' . '/includes/admin/AdminEnhancements.php',
        'AdminMenuManager' => __DIR__ . '/../..' . '/includes/admin/AdminMenuManager.php',
        'BasePostType' => __DIR__ . '/../..' . '/includes/shared/abstracts/BasePostType.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Customer' => __DIR__ . '/../..' . '/includes/domains/customers/models/Customer.php',
        'CustomerPostType' => __DIR__ . '/../..' . '/includes/domains/customers/post-types/CustomerPostType.php',
        'CustomerRepository' => __DIR__ . '/../..' . '/includes/domains/customers/repositories/CustomerRepository.php',
        'GroupItem' => __DIR__ . '/../..' . '/includes/domains/products/models/GroupItem.php',
        'GroupItemPostType' => __DIR__ . '/../..' . '/includes/domains/products/post-types/GroupItemPostType.php',
        'GroupItemRepository' => __DIR__ . '/../..' . '/includes/domains/products/repositories/GroupItemRepository.php',
        ...
        'Ingredient' => __DIR__ . '/../..' . '/includes/domains/products/models/Ingredient.php',
        'IngredientPostType' => __DIR__ . '/../..' . '/includes/domains/products/post-types/IngredientPostType.php',
        'IngredientRepository' => __DIR__ . '/../..' . '/includes/domains/products/repositories/IngredientRepository.php',
        'ItemType' => __DIR__ . '/../..' . '/includes/shared/models/enums/ItemType.php',
        'Order' => __DIR__ . '/../..' . '/includes/domains/orders/models/Order.php',
        'OrderItem' => __DIR__ . '/../..' . '/includes/domains/orders/models/OrderItem.php',
        'OrderPostType' => __DIR__ . '/../..' . '/includes/domains/orders/post-types/OrderPostType.php',
        'OrderRepository' => __DIR__ . '/../..' . '/includes/domains/orders/repositories/OrderRepository.php',
        ...
        'PaymentException' => __DIR__ . '/../..' . '/includes/domains/payments/exceptions/PaymentException.php',
        'PaymentGatewayInterface' => __DIR__ . '/../..' . '/includes/domains/payments/interfaces/PaymentGatewayInterface.php',
        'PaymentIntent' => __DIR__ . '/../..' . '/includes/domains/payments/models/PaymentIntent.php',
        'PaymentManager' => __DIR__ . '/../..' . '/includes/domains/payments/managers/PaymentManager.php',
        'PaymentRequest' => __DIR__ . '/../..' . '/includes/domains/payments/models/PaymentRequest.php',
        'PaymentResult' => __DIR__ . '/../..' . '/includes/domains/payments/models/PaymentResult.php',
        'PaymentService' => __DIR__ . '/../..' . '/includes/domains/payments/services/PaymentService.php',
        'PaymentStatus' => __DIR__ . '/../..' . '/includes/domains/payments/models/PaymentStatus.php',
        'PaymentWebhookResult' => __DIR__ . '/../..' . '/includes/domains/payments/models/PaymentWebhookResult.php',
        ...
        'PostTypeInterface' => __DIR__ . '/../..' . '/includes/shared/interfaces/PostTypeInterface.php',
        'PostTypeRegistry' => __DIR__ . '/../..' . '/includes/core/PostTypeRegistry.php',
        'Product' => __DIR__ . '/../..' . '/includes/domains/products/models/Product.php',
        'ProductGroup' => __DIR__ . '/../..' . '/includes/domains/products/models/ProductGroup.php',
        'ProductGroupPostType' => __DIR__ . '/../..' . '/includes/domains/products/post-types/ProductGroupPostType.php',
        'ProductGroupRepository' => __DIR__ . '/../..' . '/includes/domains/products/repositories/ProductGroupRepository.php',
        'ProductPostType' => __DIR__ . '/../..' . '/includes/domains/products/post-types/ProductPostType.php',
        'ProductRepository' => __DIR__ . '/../..' . '/includes/domains/products/repositories/ProductRepository.php',
        'RepositoryInterface' => __DIR__ . '/../..' . '/includes/shared/interfaces/RepositoryInterface.php',
        'ResourceInUseException' => __DIR__ . '/../..' . '/includes/shared/exceptions/ResourceInUseException.php',
        ...
        'StoreBranch' => __DIR__ . '/../..' . '/includes/domains/stores/models/StoreBranch.php',
        'StoreBranchPostType' => __DIR__ . '/../..' . '/includes/domains/stores/post-types/StoreBranchPostType.php',
        'StoreBranchRepository' => __DIR__ . '/../..' . '/includes/domains/stores/repositories/StoreBranchRepository.php',
        'StripePaymentGateway' => __DIR__ . '/../..' . '/includes/domains/payments/gateways/StripePaymentGateway.php',
